...
const level = {
  tiles: [{
    ...
    walls: [
      {pos: 'top', x: 280, h: 400, grow: 300, phase: PI_2H, freq: 0.15},
      ...
      {pos: 'top', x: 100, h: 350, w: 400, color: 'rgb(50,50,180)'},
      {pos: 'top', x: 500, h: 400, w: 180, color: 'rgb(50,50,180)'},
      {pos: 'top', x: 680, h: 380, w: 50, color: 'rgb(50,50,180)'},
      {pos: 'top', x: 730, h: 400, w: 270, color: 'rgb(50,50,180)'},
      {pos: 'bottom', x: 0, h: 400, w: 680, color: 'rgb(30,30,150)'},
    ...
    messages: [
      {restarts: 1, text: 'hold down <SPACE> to slow down'}
    ]
  }, {
    speed: 1.1,
    player: {},
    walls: [
      ...
      {pos: 'top', x: 0, h: 400, w: 260, color: 'rgb(50,50,180)'},
      {pos: 'top', x: 260, h: 380, w: 50, color: 'rgb(50,50,180)'},
      {pos: 'top', x: 310, h: 400, w: 690, color: 'rgb(50,50,180)'},
      ...
      {pos: 'bottom', x: 500, h: 350, w: 400, color: 'rgb(30,30,150)'},
    ...
    walls: [
      ...
      {pos: 'bottom', x: 720, h: 0, grow: 500, phase: PI_1H, freq: 0.7},
      {pos: 'top', x: 720, h: 0, grow: 500, phase: PI_1H, freq: 0.7},
      {pos: 'top', x: 0, h: 400, w: 230, color: 'rgb(50,50,180)'},
      {pos: 'top', x: 230, h: 380, w: 50, color: 'rgb(50,50,180)'},
      {pos: 'top', x: 280, h: 400, w: 120, color: 'rgb(50,50,180)'},
      {pos: 'top', x: 400, h: 350, w: 200, color: 'rgb(50,50,180)'},
      {pos: 'top', x: 600, h: 400, w: 100, color: 'rgb(50,50,180)'},
      {pos: 'top', x: 700, h: 380, w: 50, color: 'rgb(50,50,180)'},
      {pos: 'top', x: 750, h: 400, w: 250, color: 'rgb(50,50,180)'},
      {pos: 'bottom', x: 0, h: 400, w: 230, color: 'rgb(30,30,150)'},
      {pos: 'bottom', x: 230, h: 380, w: 50, color: 'rgb(30,30,150)'},
      {pos: 'bottom', x: 280, h: 400, w: 420, color: 'rgb(30,30,150)'},
      {pos: 'bottom', x: 700, h: 380, w: 50, color: 'rgb(30,30,150)'},
      {pos: 'bottom', x: 750, h: 400, w: 250, color: 'rgb(30,30,150)'}
    ],
    drops: [
      {trigger: 300, pos: 400, freq: 1}
    ]
    ...
    walls: [
      ...
      {pos: 'top', x: 400, h: 380, w: 50, color: 'rgb(50,50,180)'},
      {pos: 'top', x: 450, h: 400, w: 330, color: 'rgb(50,50,180)'},
      {pos: 'top', x: 780, h: 380, w: 50, color: 'rgb(50,50,180)'},
      {pos: 'top', x: 830, h: 400, w: 1000, color: 'rgb(50,50,180)'},
      {pos: 'bottom', x: 0, h: 400, w: 200, color: 'rgb(30,30,150)'},
      {pos: 'bottom', x: 200, h: 350, w: 200, color: 'rgb(30,30,150)'},
      {pos: 'bottom', x: 400, h: 380, w: 50, color: 'rgb(30,30,150)'},
      {pos: 'bottom', x: 450, h: 350, w: 180, color: 'rgb(30,30,150)'},
      {pos: 'bottom', x: 630, h: 400, w: 150, color: 'rgb(30,30,150)'},
